...
execute as @s if score @s delayPowers matches ..799 if score @s msgCD matches 20 run tellraw @s ["",{"text":"["},{"text":"Maze Wars","color":"dark_green"},{"text":"] "},{"text":"Cooldown for this power up: ","color":"gold"},{"score":{"name":"@s","objective":"delayPowersInSec"},"color":"green"},{"text":" seconds!","color":"gold"}]
execute as @s if score @s delayPowers matches ..799 if score @s msgCD matches 20 run scoreboard players set @s msgCD 0
