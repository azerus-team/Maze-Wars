...
execute if entity @p[team=Red] run tellraw @s ["",{"text":"["},{"text":"Maze Wars","color":"dark_green"},{"text":"]"},{"text":" You stole ","color":"gold"},{"text":"5","color":"green"},{"text":" stamina from ","color":"gold"},{"text":"@p","color":"white"}]
