...
execute if score @s delayPowers matches 900.. unless entity @s[x=-1996,y=-1,z=-1995,dx=54,dz=54,dy=200] run tellraw @s ["",{"text":"["},{"text":"Maze Wars","color":"dark_green"},{"text":"] "},{"text":"This power up cannot be used on the edge of a maze.","color":"gold"}]
