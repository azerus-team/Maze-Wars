...
#armor in lobby
    ...
    execute if score status mw matches 0 as @a[scores={skin=4}] run replaceitem entity @s armor.head minecraft:player_head{"Unbreakable":true,HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1}],display:{Name:"{\"text\":\"Owl\"}"},SkullOwner:{Id:"9a6109e6-8f6f-4b85-bd4d-0313bf852f7d",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvODM2OTQwZTVkNzY5NDJjYTVmZDEyZWFkYTEyZDM2MTc4OGE5MmEwYjA5NzRkYWFjYTRlZmE5ZTM2MTcifX19"}]}}} 1
    execute if score status mw matches 0 as @a[scores={skin=5}] run replaceitem entity @s armor.head minecraft:player_head{"Unbreakable":true,HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1}],display:{Name:"{\"text\":\"Pig\"}"},SkullOwner:{Id:"e1e1c2e4-1ed2-473d-bde2-3ec718535399",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNjIxNjY4ZWY3Y2I3OWRkOWMyMmNlM2QxZjNmNGNiNmUyNTU5ODkzYjZkZjRhNDY5NTE0ZTY2N2MxNmFhNCJ9fX0="}]}}} 1
    execute if score status mw matches 0 as @a[scores={skin=6}] run replaceitem entity @s armor.head minecraft:player_head{"Unbreakable":true,HideFlags:63,Enchantments:[{id:"minecraft:binding_curse",lvl:1}],display:{Name:"{\"text\":\"Cow\"}"},SkullOwner:{Id:"97ddf3b3-9dbe-4a3b-8a0f-1b19ddeac0bd",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNWQ2YzZlZGE5NDJmN2Y1ZjcxYzMxNjFjNzMwNmY0YWVkMzA3ZDgyODk1ZjlkMmIwN2FiNDUyNTcxOGVkYzUifX19"}]}}} 1
