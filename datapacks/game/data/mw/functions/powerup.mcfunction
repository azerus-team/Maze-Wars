scoreboard players set maxRandom var 37
function mw:random
    ...
    execute if score random var matches 35..36 run give @s minecraft:ink_sac{display:{Lore:["§dBlinds a random person from the opposing team"],Name:"[{\"text\":\"Black dye\",\"color\":\"black\",\"italic\":\"false\"},{\"text\":\" [Press \",\"color\":\"white\",\"italic\":\"false\"},{\"keybind\":\"key.drop\",\"color\":\"white\",\"italic\":\"false\"},{\"text\":\" to use]\",\"color\":\"white\",\"italic\":\"false\"}]"}} 1
