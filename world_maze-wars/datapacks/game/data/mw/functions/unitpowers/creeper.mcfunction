...
execute if score @s delayPowers matches ..899 if score @s msgCD matches 20 run tellraw @s ["",{"text":"["},{"text":"Maze Wars","color":"dark_green"},{"text":"] "},{"text":"Cooldown for this power up: ","color":"gold"},{"score":{"name":"@s","objective":"delayPowersInSec"},"color":"green"},{"text":" seconds!","color":"gold"}]

execute if score @s delayPowers matches ..899 if score @s msgCD matches 20 run scoreboard players set @s msgCD 0

execute if score @s delayPowers matches 900.. unless entity @s[x=-1995,y=-1,z=-1994,dx=52,dz=52,dy=200] run tellraw @s ["",{"text":"["},{"text":"Maze Wars","color":"dark_green"},{"text":"] "},{"text":"This power up cannot be used on border of the edge.","color":"gold"}]
...
execute if score @s delayPowers matches 900.. if entity @s[x=-1995,y=-1,z=-1994,dx=52,dz=52,dy=200] run playsound minecraft:block.beacon.activate master @s
